...
{
    AZ_COMPONENT_IMPL(ROS2ControllersEditorSystemComponent, "ROS2ControllersEditorSystemComponent",
        ROS2ControllersEditorSystemComponentTypeId, BaseSystemComponent);

    void ROS2ControllersEditorSystemComponent::Reflect(AZ::ReflectContext* context)
    {
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            serializeContext->Class<ROS2ControllersEditorSystemComponent, ROS2ControllersSystemComponent>()
                ->Version(0);
        }
    }
    ...
    void ROS2ControllersEditorSystemComponent::GetDependentServices([[maybe_unused]] AZ::ComponentDescriptor::DependencyArrayType& dependent)
    {
