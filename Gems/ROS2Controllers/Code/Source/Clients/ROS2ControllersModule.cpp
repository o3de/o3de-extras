...
public:
  AZ_RTTI(ROS2ControllersModule, ROS2ControllersModuleTypeId,
...
AZ_DECLARE_MODULE_CLASS(AZ_JOIN(Gem_, O3DE_GEM_NAME),
                        ROS2Controllers::ROS2ControllersModule)
#else
AZ_DECLARE_MODULE_CLASS(Gem_ROS2Controllers,
                        ROS2Controllers::ROS2ControllersModule)
#endif
