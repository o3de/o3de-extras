...
AZ_COMPONENT_IMPL(ROS2ControllersSystemComponent,
...
void ROS2ControllersSystemComponent::GetProvidedServices(
    AZ::ComponentDescriptor::DependencyArrayType &provided) {
  provided.push_back(AZ_CRC_CE("ROS2ControllersService"));
}

void ROS2ControllersSystemComponent::GetIncompatibleServices(
    AZ::ComponentDescriptor::DependencyArrayType &incompatible) {
  incompatible.push_back(AZ_CRC_CE("ROS2ControllersService"));
}

void ROS2ControllersSystemComponent::GetRequiredServices(
    [[maybe_unused]] AZ::ComponentDescriptor::DependencyArrayType &required) {}

void ROS2ControllersSystemComponent::GetDependentServices(
...
void ROS2ControllersSystemComponent::OnTick(
