...
namespace ROS2RobotImporter
{
        ...
        : QWizardPage(parent)
    {
        ...
        m_label = new QLabel(QObject::tr(
            "This wizard allows you to build a robot prefab using a URDF description file or object/environment prefab using an SDF file."
