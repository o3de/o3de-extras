...
namespace ROS2Sensors
{
    ...
    inline constexpr const char* ROS2ImageCompressionEditorComponentTypeId = "{792BD03D-E75E-4072-8500-324DB12A6C06}";
    inline constexpr const char* ImageCompressionConfigurationTypeId = "{6D01B8E0-7CB1-474A-ABA2-B3FD4582AF2C}";
