...
namespace ROS2SimulationInterfaces
{
    namespace
    {
        [[nodiscard]] SimulationInterfaces::LoadWorldRequest ConvertROS2Request(const LoadWorldServiceHandler::Request& ros2Request)
        {
            ...
            request.levelResource.m_uri = ros2Request.level_resource.uri.c_str();
            request.levelResource.m_resourceString = ros2Request.level_resource.resource_string.c_str();
            return request;
        }
    } // namespace
