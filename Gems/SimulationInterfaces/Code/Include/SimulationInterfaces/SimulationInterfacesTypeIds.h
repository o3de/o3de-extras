...
namespace SimulationInterfaces
{
    ...
    inline constexpr const char* SimulationInterfacesSystemComponentTypeId = "{4BF53AF2-A295-4F99-A166-F85FBFBDC077}";
    inline constexpr const char* SimulationInterfacesEditorSystemComponentTypeId = "{B035007B-BAD3-40FA-880F-F45054A4C232}";
