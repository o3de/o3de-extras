...
namespace ROS2::VehicleDynamics
{
    ...
    void SkidSteeringDriveModel::ApplyState(const VehicleInputsState& inputs, uint64_t deltaTimeNs)
    {
    ...
    void SkidSteeringDriveModel::SetDisabled(bool isDisabled)
    {
        m_disabled = isDisabled;
    }

    VehicleModelLimits* SkidSteeringDriveModel::GetVehicleLimits()
    {
        return &m_limits;
    }
