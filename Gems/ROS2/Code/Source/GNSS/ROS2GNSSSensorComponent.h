...
namespace ROS2
{
    ...
    class ROS2GNSSSensorComponent : public ROS2SensorTickableComponent
    {
    public:
        AZ_COMPONENT(ROS2GNSSSensorComponent, "{55B4A299-7FA3-496A-88F0-764C75B0E9A7}", ROS2SensorTickableComponent);
