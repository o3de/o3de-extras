...
# -------------------------------------------------------------------------
"""! @brief
<DCCsi>/azpy/dcc/max/__init__.py

ddc/max (3dsmax) is a sub-module of the azpy.dcc pure-python api.
If a sub-module requires an import from a 3dsMax  api like pymxs,
...
def init(_all=list()):
    """If the 3dsMax or other apis are required for a package/module to
