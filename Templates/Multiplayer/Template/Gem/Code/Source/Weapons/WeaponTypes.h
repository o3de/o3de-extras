...
namespace ${SanitizedCppName}
{
    ...
    //! Status states for a ${NameLower} weapon.
...
namespace AZ
{
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::WeaponType, "{46FBBE01-25CE-4F25-82C1-8CCC95F3700F}");
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::WeaponStatus, "{7AF237A0-E3FD-4742-92C3-1ED82D4E0546}");
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::GatherShape, "{A10A1338-C08F-498E-815C-6410ADF7DFEC}");
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::GatherDirection, "{FB7C2937-E19F-47B5-9870-DDBCB9B39D18}");
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::EffectDirection, "{AF585331-AF80-4CEE-BE6C-55E9E21F0A88}");
}
