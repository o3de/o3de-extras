...
namespace ${SanitizedCppName}
{
    ...
    //! Status states for a ${SanitizedCppName} weapon.
    ...
    struct GatherParams
    {
        AZ_TYPE_INFO(GatherParams, "{${Random_Uuid}}");
    ...
    struct HitEffect
    {
        AZ_TYPE_INFO(HitEffect, "{${Random_Uuid}}");
    ...
    struct WeaponParams
    {
        AZ_TYPE_INFO(WeaponParams, "{${Random_Uuid}}");
    ...
    struct HitEntity
    {
        AZ_TYPE_INFO(HitEntity, "{${Random_Uuid}}");
    ...
    struct HitEvent
    {
        AZ_TYPE_INFO(HitEvent, "{${Random_Uuid}}");
...
namespace AZ
{
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::WeaponType, "{${Random_Uuid}}");
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::WeaponStatus, "{${Random_Uuid}}");
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::GatherShape, "{${Random_Uuid}}");
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::GatherDirection, "{${Random_Uuid}}");
    AZ_TYPE_INFO_SPECIALIZE(${SanitizedCppName}::EffectDirection, "{${Random_Uuid}}");
}

AZ_TYPE_SAFE_INTEGRAL_SERIALIZEBINDING(${SanitizedCppName}::WeaponIndex);
